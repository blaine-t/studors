...
create table sessions(
  time_id timestamp with time zone references times(time) not null,
  subject_id text references subjects(subject) ON delete cascade not null,
